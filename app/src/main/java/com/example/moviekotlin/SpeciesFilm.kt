...
class SpeciesFilm(urls: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewOfLayout = inflater!!.inflate(R.layout.fragment_speciesfilm, container, false)

        tvSpeciesFilm = viewOfLayout.findViewById(R.id.tvspeciesfilm)
